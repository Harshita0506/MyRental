      ...
      <div className="container mx-auto flex flex-col lg:flex-row items-center px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-6 w-3/4 m-auto lg:m-0 lg:mb-6">
            Hi, I’m a passionate developer currently pursuing MTech at NIT Bhopal.
          ...
          <div className="flex justify-center lg:justify-start space-x-6">
            <a
              href="https://github.com/Harshita0506"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/harshita-gadwe-4b344b228"
              target="_blank"
              rel="noopener noreferrer"
